...
apply_theme() {
    ...
    pane_active_border_fg=colour2 # green
    ...
    window_status_fg=colour7 # light gray
    ...
    window_status_current_fg=colour18 # black
    window_status_current_bg=colour2 # green
    ...
    window_status_last_fg=colour2 # greengreengreengreen
    ...
    time_date_fg=colour7        # light gray
    time_date_bg=colour0        # dark gray
    host_fg=colour18            # black
    host_bg=colour254           # white

    tmux set -g status-right-length 64
    tmux set -g status-right "#[fg=$time_date_fg,nobold] $right_separator %R $right_separator %a %d %b #[fg=$host_bg] $right_separator_black#[fg=$host_fg,bg=$host_bg,bold] #{battery_icon} #{battery_percentage} $right_separator CPU #{cpu_percentage} "

    # clock
    clock_mode_colour=colour2 # green
